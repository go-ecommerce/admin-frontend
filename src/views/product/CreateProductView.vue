...
const saveAll = async () => {
  ...
  try {
    ...
    await createProduct({
      ...
      price_retail: productInfo.value.price_retail,
      price_business: productInfo.value.price_business,
      price_wholesale: productInfo.value.price_wholesale,
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
      ...
      <div class="flex flex-col gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <NumberField v-model="productInfo.price_retail" class="mb-4">
            ...
            <NumberField v-model="productInfo.price_wholesale" class="mb-4">
            ...
            <NumberField v-model="productInfo.price_business">
